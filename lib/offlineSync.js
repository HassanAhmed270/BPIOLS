...
async function syncOfflineSale(offlineSale, { cashier }) {
  ...
  try {
    await session.withTransaction(async () => {
      console.log('OFFLINE CUSTOMER DEBUG:', {
        value: offlineSale.customerName,
        jsonValue: JSON.stringify(offlineSale.customerName),
        expected: WALKIN_CUSTOMER,
        isWalkIn: offlineSale.customerName === WALKIN_CUSTOMER,
        length: offlineSale.customerName?.length,
      });
