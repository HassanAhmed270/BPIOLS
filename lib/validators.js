...
// Accepts both the current sequential invoice format ("INV-0001", ...,
// growing past 4 digits without truncation) and the legacy random
// "#dddd" format still sitting on pre-existing orders — so an old order
// re-saved (e.g. a refund) keeps passing Mongoose's match validator.
// Every newly generated ID (lib/orderId.js) is always "INV-dddd+".
const ORDER_ID_RE = /^(?:INV-\d{4,}|#\d{4})$/;
